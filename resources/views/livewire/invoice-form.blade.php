    ...
    <form wire:submit.prevent="save">
        ...
        <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white dark:bg-gray-800">
            ...
            <div class="flex items-center gap-3 w-full sm:w-auto justify-end">
                <a href="{{ route('invoices.index') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 text-sm font-medium transition cursor-pointer">
                    Cancel
                </a>
        ...
        <div class="p-8 space-y-8 bg-gray-50/50 dark:bg-gray-900/50 min-h-screen">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                 <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <!-- Client Selection -->
                    <div>
                        <div class="text-xs text-red-500 font-mono mb-2">DEBUG: ClientID: [{{ $client_id }}]</div>
                    ...
                    <div>
                        ...
                        <input type="date" wire:model="due_date" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Notes -->
                <div class="space-y-2">
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider">Notes & Payment Terms</label>
