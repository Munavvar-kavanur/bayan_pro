    ...
    <form wire:submit.prevent="save">
        ...
        <div class="px-8 py-6 border-b border-white/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white/5 backdrop-blur-sm">
            ...
            <div class="flex items-center gap-3 w-full sm:w-auto justify-end">
                <a href="{{ route('invoices.index') }}" class="text-slate-400 hover:text-white text-sm font-medium transition-colors cursor-pointer">
                    Cancel
                </a>
        ...
        <div class="p-8 space-y-8 bg-transparent">
            ...
            <div class="glass rounded-xl p-6 relative z-20">
                 <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <!-- Client Selection -->
                    <div>
                        <!-- <div class="text-xs text-rose-500 font-mono mb-2">DEBUG: ClientID: [{{ $client_id }}]</div> -->
                    ...
                    <div>
                        ...
                        <input type="date" wire:model="due_date" style="color-scheme: dark;" class="w-full rounded-lg bg-slate-900/50 border-white/10 text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm text-slate-400">
                        ...
                        <tbody class="divide-y divide-white/5">
                            ...
                            <tr wire:key="item-row-{{ $index }}" class="hover:bg-white/5 group transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Notes -->
                <div class="space-y-2">
                    <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider">Notes & Payment Terms</label>
