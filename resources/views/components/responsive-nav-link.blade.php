...
@php
    $classes = ($active ?? false)
        ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-indigo-400 text-start text-base font-medium text-indigo-400 bg-indigo-500/10 focus:outline-none focus:text-indigo-300 focus:bg-indigo-500/20 focus:border-indigo-500 transition duration-150 ease-in-out'
